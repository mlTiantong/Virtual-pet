...
public partial class PetWindow : Window
{
    ...
    public PetWindow()
    {
        ...
        _catalog.Preload("idle_m8", "hover_m8", "drag_start", "drag_hold", "drop", "pat_head_m8", "face_reaction_m8", "clasp_idle_m8", "tap_annoyed", "hand_invite_m8", "study_guard_m8", "sleepy_m8", "plush_hug_m8", "talking", "rest_tea", "idle_cheer_m8", "photo_m8", "draw_m8", "tongue_m8");
